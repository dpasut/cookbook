\begin{recipe}{Breadmaker Citrus Cranberry Bread}{1 Loaf}{}

    \Ing{1 cup warm water}
    \Ing{2 tbps kosher salt}
    \Ing{2 tbsp white sugar}
    \Ing{2 tbsp brown sugar}
    \Ing{1 heaping tsp lemon/orange zest}
    \Ing{3 cups (360g) flour}
    \Ing{$2\nicefrac{1}{2}$ tsp yeast}
    \Ing{$\nicefrac{3}{4}$ cup dried cranberries, soaked for 5 minutes in hot water}
