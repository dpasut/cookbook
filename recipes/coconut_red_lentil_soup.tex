\begin{recipe}{$\star$Coconut Red Lentil Soup}{6 servings - 306 calories}{}
...
\Ing{2 tablespoons fresh peeled and minced ginger}
\Ing{2 tablespoons curry powder}
\Ing{2 tablespoons butter, ghee, or coconut oil}
\Ing{8 green onions (scallions), thinly sliced}
\Ing{3 tablespoons golden raisins}
\Ing{\nicefrac{1}{3} cup / 80 ml tomato paste}
\Ing{1 14-ounce can coconut milk}
\Ing{2 teaspoons fine grain sea salt}
