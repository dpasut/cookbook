\begin{recipe}{\texorpdfstring{$\star$}{str}Tempeh Taco Salad}{4 servings - 410 calories}{}

\freeform From 101 Cookbooks.

\Ing{2 tsp extra virgin coconut or olive oil}
\Ing{8 ounces tempeh}
\Ing{1 tbsp taco seasoning\\}
\Ing{\nicefrac{1}{3} cup ketchup}
\Ing{\nicefrac{1}{2} cup apple cider vinegar}
\Ing{2 tbsp coconut nectar, maple syrup, or honey}
