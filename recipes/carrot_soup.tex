\begin{recipe}{$\star$Carrot Soup with Lemon, Tahini and Crisped Chickpeas}{4 servings - 447 calories}{}

\freeform From Smitten Kitchen.\\

\Ing{\textbf{Soup}}
\Ing{2 tablespoons (30 ml) olive oil}
...
\Ing{\nicefrac{1}{4} teaspoon ground coriander}
\Ing{\nicefrac{1}{2} teaspoon ground cumin}
\Ing{\nicefrac{1}{2} teaspoon table salt, plus more if needed}
...
\Ing{1 generous tablespoon (15 ml or so) olive oil}
