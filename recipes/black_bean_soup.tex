\begin{recipe}{\texorpdfstring{$\star$}{str}Black Bean Soup with Toasted Cumin Seed Crema}{6 servings - 321 calories}{}
...
\Ing{4 tsp ground cumin}
\Ing{1 16-ounce package dried black beans}
\Ing{1 tbsp chopped chipotle chiles from a can (this gives it a solid kick, dial back if you are wary)}
\Ing{7 cups hot water (can use very hot tap water)}
\Ing{2 tbsp fresh lime juice}
\Ing{2 tsp coarse kosher salt}
\Ing{\nicefrac{1}{4} tsp ground black pepper\\}
\Ing{\textbf{Crema} (+138 cal)}
\Ing{1 tbsp whole cumin seeds}
